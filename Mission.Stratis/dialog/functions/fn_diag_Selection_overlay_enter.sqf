...
switch (ctrlIDC _control) do {
	case IDC_SELECTION_SCREEN_INVI_POLICE :
	{
		...
		_outline ctrlSetTextColor [COLOR_POLICE_HOVER];
		_button = (_display displayCtrl IDC_SELECTION_SCREEN_BTN_POLICE);
		_button ctrlSetTextColor [COLOR_POLICE_HOVER];
		/*_newPos = [];
		{
			_newPos pushBack (parseNumber _x);
		} forEach (getArray (missionConfigFile >> "SelectionScreen" >> ctrlClassName _button >> "activeDimension"));
	...
	case IDC_SELECTION_SCREEN_INVI_CIVILIAN :
	{
		...
		_outline ctrlSetTextColor [COLOR_CIVILIAN_HOVER];
		_button = (_display displayCtrl IDC_SELECTION_SCREEN_BTN_CIVILIAN);
		_button ctrlSetTextColor [COLOR_CIVILIAN_HOVER];
		/*_newPos = [];
		{
			_newPos pushBack (parseNumber _x);
		} forEach (getArray (missionConfigFile >> "SelectionScreen" >> ctrlClassName _button >> "activeDimension"));
	...
	case IDC_SELECTION_SCREEN_INVI_MEDICAL :
	{
		...
		_outline ctrlSetTextColor [COLOR_MEDICAL_HOVER];
		_button = (_display displayCtrl IDC_SELECTION_SCREEN_BTN_MEDICAL);
		_button ctrlSetTextColor [COLOR_MEDICAL_HOVER];
		/*_newPos = [];
		{
			_newPos pushBack (parseNumber _x);
		} forEach (getArray (missionConfigFile >> "SelectionScreen" >> ctrlClassName _button >> "activeDimension"));
	...
	default {
		_control ctrlSetTextColor [COLOR_MEDICAL_HOVER];
